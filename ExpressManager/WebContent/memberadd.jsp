...
<!--面包屑导航-->
 <div>
	...
	<div class="container" class="container" style="margin-top:20px">
		<div class="row clearfix">
			<div class="col-md-6 column">
				<!-- onsubmit="isPoneAvailable()" -->
				<form class="form-horizontal"
					action="${pageContext.request.contextPath}/member/add.do"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<font color="red" id="msgman">${msgman}</font>
							<font color="red" id="msgwoman">${msgwoman}</font>
						</div>
					</div>
					<div class="form-group">
