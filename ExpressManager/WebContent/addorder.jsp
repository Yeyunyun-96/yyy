...
<body style="background-image: url(${APP_PATH }/image/backg.jpg);-moz-background-size:100% 100%; background-size:100% 100%;">
	<div style="background-color: rgba(246,246,246,0.9);">
	<h3 style="text-align: center; margin-top: 15px;">请认真填写快递单：</h3>
	<form id="fm1" action="${pageContext.request.contextPath}/main/addorder.do" method="post">
	<div class="demo">
		<!-- 在输入框加入id -->
		...
		<input type="text"
			...
			placeholder="请输入寄发地">
			 <label for="fromlocation">寄发详细地址</label>
