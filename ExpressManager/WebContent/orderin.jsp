...
<body>
<h3 style="text-align: center;margin-top:60px;" >在下面的输入框中输入所操作的物流单号：</h3>
<div class="demo" >
	<!-- 在输入框加入id -->
	<form id="form1" action="${APP_PATH }/main/orderin.do" method="post">
...
function fmsub(){
	...
	$("#form1").attr("action","${APP_PATH}/main/orderin.do");
	$("#form1").submit();
}
function fmsub1(){
	var expid = $("#expid").val();
